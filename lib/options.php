...
class EstimatedPostReadingTimeOptions {
	...
	function plugin_options_page() {
		...
		<div class="wrap">
			<h2><?php _e('Estimated Post Reading Time', 'estimated-post-reading-time'); ?></h2>
			...
			<form name="att_img_options" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<p><label for=""><?php _e('Words Per Minute', 'estimated-post-reading-time'); ?>:</label>
				...
				<p><label for=""><?php _e('Show in homepage', 'estimated-post-reading-time'); ?>:</label>
				...
				<p><label for=""><?php _e('Show in archives', 'estimated-post-reading-time'); ?>:</label>
				...
				<p><label for=""><?php _e('All letters lowercase', 'estimated-post-reading-time'); ?>:</label>
